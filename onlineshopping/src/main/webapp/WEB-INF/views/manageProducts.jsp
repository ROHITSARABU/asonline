						...
						<div class="form-group">
							...
							<div class="col-md-8">
								...
								<sf:input type="number" path="quantity" id="quantity"
									placeholder="Quantiy Available" class="form-control" />
	...
	<div class="modal-dialog" role="document">
		...
		<!-- modal header -->
			<div class="modal-header">
				...
				<h4 class="model-title">Add New Category</h4>
			</div>
			<div class="modal-body">
				...
				<sf:form id="categoryForm" modelAttribute="category" action="${contextRoot}/manage/category" method="POST" class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-md-8">
							<sf:input path="name" type="text" class="form-control" id="category_name"/>
						</div>
					</div>
